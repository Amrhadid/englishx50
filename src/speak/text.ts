...
export const T = {
  ...
  micInstruction: 'اضغط وتكلم — سيظهر رد Emma بعد الانتهاء',
  ...
  recording: 'جارٍ التسجيل… اضغط مرة أخرى للإنهاء',
  transcribing: 'جارٍ تحويل كلامك إلى نص…',
  thinking: 'Emma بتفكر في الرد…',
  speaking: 'Emma بتتكلم…',
  ...
  feedbackTitle: 'ملاحظة سريعة',
  feedbackOriginal: 'قلت',
  feedbackSuggested: 'الأفضل',
  feedbackWhy: 'ليه؟',
  retry: 'حاول مرة أخرى',
  dismiss: 'حسناً',
