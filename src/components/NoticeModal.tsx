...
/** Small centered message modal (e.g. "finish the videos first"). */
  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2 className="mb-2 text-2xl font-black text-[#1b1730]">{title}</h2>
        <p className="text-[14px] font-semibold leading-relaxed text-[#7a7596]">{message}</p>
