...
/**
 * Shown when a premium user opens a challenge before taking the level test —
 * the test is the mandatory first step of the program.
 */
export default function LevelTestRequiredModal({
  onClose,
  onStart,
}: {
  onClose: () => void
  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2 className="mb-2 text-2xl font-black text-[#1b1730]">أكمل اختبار المستوى أولاً</h2>
        <p className="text-[14px] font-semibold leading-relaxed text-[#7a7596]">
          اختبار المستوى هو أول خطوة في التحدي — قيّم مستواك في التحدّث قبل ما تبدأ التحدي الأول.
        </p>
